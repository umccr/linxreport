...
[linxreport](https://umccr.github.io/linxreport/) is an R package for
generating a HTML report with results from the `LINX` structural variant
tool from the Hartwig Medical Foundation - see documentation for LINX at
<https://github.com/hartwigmedical/hmftools/tree/master/linx>.

For useful functions for parsing and processing `LINX` results, see
<https://umccr.github.io/linxreport/reference>.

> \[!NOTE\] [linxreport](https://umccr.github.io/linxreport/) does not
> run any analyses! It simply parses the outputs from LINX and displays
> them in tables and tabs. No optimisations are performed.
...
output the HTML to. See
[`?linx_rmd`](https://umccr.github.io/linxreport/reference/linx_rmd.md)
for more.
...
the command line. Quick example:
